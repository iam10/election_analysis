...
def send_notification_via_pushbullet(title, body):
    ...
    ACCESS_TOKEN = os.environ['PUSH_BULLET_ACCESS_TOKEN']
...
while True:
    ...
    # Send myself a notification the bucket has been updated
    send_notification_via_pushbullet('Updated Bucket at: '+datetime.datetime.now().strftime("%H:%M:%S"), '')
